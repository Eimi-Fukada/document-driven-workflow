...
$contentChecks = @(
    ...
    @{ Name = "POSITIONING.md explains Maestro layered fit"; Pass = $positioning -match "Codex / Claude Code" -and $positioning -match "handoff-pack.json" -and $positioning -match "completion-check --json" },
    ...
    @{ Name = "MAESTRO_INTEGRATION.md documents parallel dispatch boundaries"; Pass = $maestroIntegration -match "ready_for_implementation" -and $maestroIntegration -match "completion-check --json" -and $maestroIntegration -match "Integration Contract" },
