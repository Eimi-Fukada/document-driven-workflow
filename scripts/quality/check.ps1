...
$contentChecks = @(
    ...
    @{ Name = "USAGE.md documents main script entries"; Pass = $usage -match "process.mjs" -and $usage -match "continue.mjs" -and $usage -match "verify.mjs" -and $usage -match "doctor.mjs" -and $usage -match "completion-check.mjs" -and $usage -match "finish-feature.mjs" },
    ...
    @{ Name = "AUTOMATION.md documents main entries"; Pass = $automation -match "process.mjs" -and $automation -match "continue.mjs" -and $automation -match "verify.mjs" -and $automation -match "doctor.mjs" -and $automation -match "completion-check.mjs" -and $automation -match "finish-feature.mjs" },
